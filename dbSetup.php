...
$setup = array(
	...
	"CREATE TABLE track_tables_info (id int(11) NOT NULL AUTO_INCREMENT, tableName varchar(256) NOT NULL, trackName varchar(256), createDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, trackDate datetime, owner varchar(256) NOT NULL, userDescr varchar(256) DEFAULT NULL, userPhotoAlbumURL varchar(256) DEFAULT NULL, userHikeLogURL varchar(256) DEFAULT NULL, PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=latin1",
